...
export default function DMHome() {
    return (
        <div className="mx-auto max-w-7xl px-4 py-10">
            <h1 className="mb-6 text-3xl font-black tracking-tight">Dungeon Master Tools</h1>
            <div className="grid gap-6 md:grid-cols-2">
                <Card to="/dj" title="Ambience DJ" subtitle="Mix & manage background sounds" icon="🎚️" />
                <Card to="/combat" title="Combat Tracker" subtitle="Initiative, HP, conditions" icon="⚔️" />
                <Card to="/levels" title="Level-Up Cards" subtitle="Reference for helping players" icon="🧙‍♂️" />
                <Card to="/spells" title="Spells Browser" subtitle="Look up spells quickly" icon="📜" />
            </div>
        </div>
    );
}